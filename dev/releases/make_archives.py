...
with working_directory(tmpdir + "/" + basename):
    ...
    # FIXME Huh? Currently we just take the pkg manuals as they come...
    ...
    with working_directory(path_to_json_package):
        ...
        subprocess.run(["rm", "-rf", "bin/", "Makefile"], check=True)
...
# Create an archive via shutil.make_archive, put it in the tmpdir, and
# record the filename of the archive in <manifest_list>.
