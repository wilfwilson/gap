...
# Given the <filename> of a file that does not end with .sha256,
# get or create the corresponding sha256 checksum file <filename>.sha256,
# (comparing checksums just to be safe, if possible), and
# upload <filename> and <filename>.sha256 as assets to the GitHub <release>.
